...
class MainView():
    ...
    def buildMenu(self):
        """
        Method building the menu in top of the window
        :return:menu
        """
    ...
    def buildTableCheckBox(self):
        """
        Checkbox to show/hide the colums of labels
        :return: checkbox
        """
    ...
    def buildDoubleSpinBox(self):
        """
        Spinbox above the slider, it contains a value which will be used in predictions after pushing the button
        value is in %, so minimum value = 0, maximum value = 100
        :return:spinbox
        """
        minimum = 0
        maximum = 100
    ...
    def buildSlider(self):
        """
        Slider which can control the spiner
    ...
    def buildSliderButton(self):
        """
        Slider button which make a prediction after pushing it
        :return: button
        """
        size_policy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
    ...
    def openFileDialog(self):
        """
        File dialog which will, open the json file to hhe table
        :return:
        """
